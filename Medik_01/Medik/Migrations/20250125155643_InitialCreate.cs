        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "integer", nullable: false),
                    StartIllness = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndIllness = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedDocumentations", x => x.Id);
                    table.ForeignKey(
